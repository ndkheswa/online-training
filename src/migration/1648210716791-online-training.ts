...
export class onlineTraining1648210716791 implements MigrationInterface {
    name = 'onlineTraining1648210716791'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "chapter" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "duration" character varying NOT NULL, "url" character varying NOT NULL, "sectionId" integer, CONSTRAINT "PK_275bd1c62bed7dff839680614ca" PRIMARY KEY ("id"))`);
