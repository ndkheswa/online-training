...
export class onlineTraining1648501471881 implements MigrationInterface {
    name = 'onlineTraining1648501471881'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "section" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "courseId" uuid, CONSTRAINT "PK_3c41d2d699384cc5e8eac54777d" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "chapter" ("id" SERIAL NOT NULL, "title" character varying NOT NULL, "duration" character varying NOT NULL, "fileId" integer, "sectionId" integer, CONSTRAINT "REL_e3889f6cc026acff6872aeeddb" UNIQUE ("fileId"), CONSTRAINT "PK_275bd1c62bed7dff839680614ca" PRIMARY KEY ("id"))`);
